...
# [XA]
# Failure to run python if the current directory is under C:\cygwin_wm to specify the acpype's python as an absolute path, since you may do
# Sometimes the python fails to run if the current directory is under C:\cygwin_wm, Specify the python by absolute path.
...
# learnt from 22 residues test.
# [XA] Increase the supported atoms for OPLS.
dictAtomTypeGaff2OplsGmxCode = {'cc': ['500', '506', '507', '508', '514', '12.011'], 'ca': ['145', '166', '501', '502', '12.011'], 'h1': ['140', '1.008'], 'h4': ['146', '1.008'], 'h5': ['146', '1.008'], 'cz': ['302', '12.011'], 'c2': ['509', '510', '12.011'], 'nh': ['300', '303', '14.0067'], 'ha': ['146', '1.008'], 'na': ['503', '512', '14.0067'], 'nc': ['511', '14.0067'], 'nd': ['511', '14.0067'], 'hx': ['140', '1.008'], 'hs': ['204', '1.008'], 'hn': ['240', '241', '290', '301', '304', '310', '504', '513', '1.008'], 'ho': ['155', '168', '1.008'], 'c3': ['135', '136', '137', '149', '157', '158', '206', '209', '210', '223B', '224B', '245', '246', '274', '283', '284', '285', '292', '292B', '293B', '296', '307', '308', '505', '12.011'], 'hc': ['140', '1.008'], 'cd': ['500', '506', '507', '508', '514', '12.011'], 'c': ['235', '271', '12.011'], 'oh': ['154', '167', '15.9994'], 'ss': ['202', '32.06'], 'o': ['236', '272', '15.9994'], 'n': ['237', '238', '239', '14.0067'], 'n4': ['287', '309', '14.0067'], 'os': ['180', '467', '15.9994'], 'f': ['164', '719', '786', '965', '18.99840'], 'cl': ['151', '123', '35.45300'], 'br': ['722', '79.90400'], 'He': ['130', '4.00260'], 'Ne': ['129', '20.17970'], 'Ar': ['097', '39.94800'], 'Kr': ['098', '83.79800'], 'Xe': ['099', '131.29300'], 'p5': ['785', '30.97376'], 'p5': ['785', '30.97376'], 'sh': ['200', '201', '32.06'], 's': ['202', '203', '32.06'], 's4': ['124', '32.06'], 'n3': ['101', '102', '103', '286', '287', '309', '427', '14.0067'], 'no': ['101', '102', '103', '286', '287', '309', '427', '14.0067']}
...
class ACTopol(AbstractTopol):
    ...
    def __init__(self, inputFile, chargeType='bcc', chargeVal=None,
        ...
        if not os.path.exists(self.acExe):
            ...
            return None
# [XA]
# Add the -dr no option to antechamber.
        self.acExe += ' -dr no '
